...
export const forInvestorsHeroAr: Localised<typeof forInvestorsHero> = {
  ...
  lead: "تنظّم Gulf Connect جلسات تعريفية مع شركات عالمية مدرجة تعمل في المعادن الحيوية، والذكاء الاصطناعي والبنية التحتية للبيانات، وعلوم الحياة، وتنشر تعليقًا مكتوبًا عن هذه القطاعات موجَّهًا إلى جمهور خليجي.",
};
...
export const investorBenefitsAr: Localised<typeof investorBenefits> = {
  ...
  items: [
    ...
    },
    {
      ...
      term: "الموجز الخليجي",
      description:
        "نشرة مكتوبة كل أسبوعين عمّا يتحرك في أسواق المال الخليجية وفي القطاعات الثلاثة التي نغطيها. تعليق فحسب.",
    },
    {
    ...
    },
    {
      ...
      description:
        "خمسة أسئلة — مقابلة بصيغة ثابتة مع الرئيس التنفيذي لشركة في أحد القطاعات الثلاثة.",
    },
  ],
};
...
export const investorsReachAr: Localised<typeof investorsReach> = {
  ...
  paragraphs: [
    "الشركات التي تُنظَّم لها الجلسات التعريفية شركات عالمية — شركات مدرجة صغيرة ومتوسطة الحجم تعمل في المعادن الحيوية، والذكاء الاصطناعي والبنية التحتية للبيانات، وعلوم الحياة، ويقع مقرها بعيدًا عن المنطقة.",
...
export const coverageAr: Localised<typeof coverage> = {
  label: "ما نغطيه",
  heading: "ثلاثة قطاعات، بتغطية متسقة",
  intro:
    "تتركّز الجلسات التعريفية والمحتوى المكتوب على ثلاثة مجالات. والتركيز ضيّق عن قصد: ينبغي للقارئ الذي يتابع أحد هذه القطاعات أن يجد التغطية جديرة بوقته، لا أن يجد قليلًا من كل شيء.",
  sectors: [
    {
